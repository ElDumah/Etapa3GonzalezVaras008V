...
class Cliente(ModeloBase):
    ...
    imagen_referencial = models.ImageField('Imagen Referencial', null = True, blank = True,upload_to = 'clientes/')
...
class Post(ModeloBase):
    modelo = models.CharField('Modelo de automovil del Post',max_length = 150, unique = True)
